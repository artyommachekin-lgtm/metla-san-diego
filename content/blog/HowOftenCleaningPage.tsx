            ...
            <article className="py-12">
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto prose prose-lg prose-slate">
                        ...
                        <ul className="text-slate-600 space-y-2 my-4"><li>Couples or small families (1-2 kids) who do light tidying between visits</li><li>Homes with one pet or no pets</li><li>Mid-size homes (1,500-2,500 sq ft) — including the townhomes and condos common in areas like <Link href="/blog/university-city-house-cleaning-guide" className="text-teal-700 hover:text-teal-800 underline">University City</Link></li><li>Anyone who wants the home to feel fresh without the expense of weekly service</li></ul>
