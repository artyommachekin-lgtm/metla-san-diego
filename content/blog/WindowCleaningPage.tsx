            ...
            <article className="py-12">
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto prose prose-lg prose-slate">
                        ...
                        <RelatedArticles currentSlug="how-to-clean-windows-like-a-pro" />
