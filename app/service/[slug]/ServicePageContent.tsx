...
const SERVICE_FAQS: Record<string, FAQItem[]> = {
  'standard-cleaning': [
    ...
    { question: 'How often should I schedule standard cleaning?', answer: 'Most clients choose weekly or bi-weekly cleanings to maintain their home, though we also offer monthly house cleaning in San Diego for lighter needs. Weekly service is ideal for busy households, families with children or pets, while a biweekly maid service works well for smaller homes or individuals. We recommend starting with bi-weekly and adjusting based on your needs.' },
  ...
  'post-construction-cleaning': [
    { question: 'What does post-construction or post-renovation cleaning include?', answer: 'Post-construction cleaning removes all construction debris, fine dust from every surface, sticker residue from windows and fixtures, paint splatters, and sanitizes the entire space. We clean inside new cabinets and closets, wipe down all fixtures, and make your renovated space move-in ready.' },
  ...
  'vacation-rental-cleaning-airbnb': [
    { question: 'How quickly can you turn over my vacation rental?', answer: 'Standard turnover cleaning takes 2-4 hours depending on property size. We offer same-day and emergency Airbnb and VRBO cleaning in San Diego for last-minute bookings. Many hosts add us to their Airbnb or VRBO calendar access so we can coordinate directly with check-out and check-in times.' },
  ...
  'move-in-out-cleaning': [
    ...
    { question: 'Can move-out cleaning help with my deposit?', answer: 'A professional move-out cleaning, sometimes called end of lease cleaning in San Diego, can significantly improve your chances of getting your full security deposit returned. We meet or exceed property management cleaning standards and can provide a cleaning receipt for documentation.' },
...
const ServicePageContent: React.FC<ServicePageContentProps> = ({ slug }) => {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-teal-50 border-l-4 border-teal-500 p-6 rounded-r-lg mb-8 definition-box">
            ...
            <p className="text-slate-700">
              ...
              {service.id === 'deep' && ' Unlike regular cleaning, deep cleaning addresses hidden grime, cleans baseboards, ceiling fans, blinds, light fixtures, and cabinet fronts, and resets your home to spotless condition\u2014ideal as a one-time deep clean or scheduled every 3-6 months to maintain a healthy home.'}
          ...
          <div className="prose prose-lg max-w-none text-slate-600">
            ...
            {service.checklist ? (
              <div className="mb-12">
                <h3 className="text-2xl font-bold mb-8 text-slate-900">Detailed Checklist</h3>
            ...
            <div className="text-center mt-12">
              ...
              <p className="mt-3 text-sm opacity-90">
                <Link href="/specials" className="underline hover:no-underline">View current specials</Link> — save on your first booking
              </p>
            </div>
          </div>
        </div>
