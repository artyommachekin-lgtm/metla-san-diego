        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-slate-300">{SITE_CONFIG.socialProof.aggregateRating.ratingValue}/5 Rating &bull; {SITE_CONFIG.socialProof.aggregateRating.ratingCount}+ Reviews</span>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-6">
              <Link href="/blog" className="inline-flex items-center text-teal-700 font-medium hover:text-teal-800 transition-colors">
