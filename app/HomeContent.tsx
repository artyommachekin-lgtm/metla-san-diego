      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Link href="/blog/deep-cleaning-guide-san-diego" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all">
              <div className="p-6">
            ...
            <Link href="/blog/vacation-rental-cleaning-tips-for-hosts" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all">
              <div className="p-6">
      ...
      <section className="py-16 bg-slate-100">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            <Link href="/faq" className="bg-white p-5 rounded-lg text-center hover:shadow-md transition-shadow border border-slate-200 group">
            ...
            <Link href="/same-day-cleaning" className="bg-white p-5 rounded-lg text-center hover:shadow-md transition-shadow border border-slate-200 group">
            ...
            <Link href="/house-cleaning" className="bg-white p-5 rounded-lg text-center hover:shadow-md transition-shadow border border-slate-200 group">
            ...
            <Link href="/about" className="bg-white p-5 rounded-lg text-center hover:shadow-md transition-shadow border border-slate-200 group">
